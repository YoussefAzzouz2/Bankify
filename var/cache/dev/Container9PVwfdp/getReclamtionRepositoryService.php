 ...
 */
class getReclamtionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReclamtionRepository' shared autowired service.
     *
     * @return \App\Repository\ReclamtionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReclamtionRepository.php';

        return $container->privates['App\\Repository\\ReclamtionRepository'] = new \App\Repository\ReclamtionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
