 ...
 */
class getChequeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ChequeRepository' shared autowired service.
     *
     * @return \App\Repository\ChequeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ChequeRepository.php';

        return $container->privates['App\\Repository\\ChequeRepository'] = new \App\Repository\ChequeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
