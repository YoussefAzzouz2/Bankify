 ...
 */
final class Version20240221153929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cheque (id INT AUTO_INCREMENT NOT NULL, destination_c_id INT DEFAULT NULL, compte_id_id INT DEFAULT NULL, montant_c DOUBLE PRECISION NOT NULL, INDEX IDX_A0BBFDE9327612E2 (destination_c_id), INDEX IDX_A0BBFDE986A5793C (compte_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
