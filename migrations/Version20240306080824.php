 ...
 */
final class Version20240306080824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE calendar_event (id INT AUTO_INCREMENT NOT NULL, event_name VARCHAR(255) DEFAULT NULL, event_start_date DATE DEFAULT NULL, event_end_date DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
